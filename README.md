# ServeTrack - Real-time Food Detection System

A modern food detection and tracking system using YOLO-World and MobileNet for real-time object detection with a React frontend and Flask backend.

## 🚀 Features

- **Real-time Detection**: Uses YOLO-World for fast and accurate object detection
- **Smart Tracking**: MobileNet-based embedding for precise item classification
- **Live Video Feed**: Real-time camera feed with annotated detections
- **Menu Management**: Easy-to-use interface for adding and managing menu items
- **ROI Settings**: Define regions of interest for accurate detection
- **Schedule Management**: Configure detection schedules and automation
- **Analytics Dashboard**: Visual insights into detection statistics
- **Modern UI**: Beautiful, responsive React interface with Tailwind CSS
- **MySQL Database**: Robust data storage and analytics [[memory:3312567]]
...
- MySQL 8.0 or higher
- PM2 (for backend process management) [[memory:3312555]]
